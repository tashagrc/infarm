              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 10),
                      child: "Deskripsi Produk".text.color(black).fontFamily(bold).size(20).make(),
                    ),
                    5.heightBox,
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 10),
                    ...
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 10),
                      child: "Produk yang mungkin kamu suka".text.fontFamily(bold).size(18).color(black).make(),
                    ),
                    15.heightBox,
            ...
            SizedBox(
              ...
              child: button(
                ...
                onPress: () {
                  ...
                  VxToast.show(context, msg: "Berhasil menambah ke keranjang");
                },
                textColor: white,
                text: "Add to cart"
              )
